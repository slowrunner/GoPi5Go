...
my_distance_sensor = gpg.init_distance_sensor(port="RPI_1")
# my_distance_sensor = distance_sensor.DistanceSensor(bus="RPI_1")
my_easy_distance_sensor = easy_distance_sensor.EasyDistanceSensor(port="RPI_1")

if my_distance_sensor:
  print("distance sensor created")
  print("dist:",my_distance_sensor.read_range_single(),"mm")
else:
