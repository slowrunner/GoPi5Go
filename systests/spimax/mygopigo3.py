...
CHANGE-LOG:
 - version 1.3.2.a:
   - Slower SPI Max Speed for Raspberry Pi 5 (244KHz) to avoid No SPI Response exceptions
   - pigpiod no longer required (pins 9,10,11 set to ALT0 by PiOS Bookworm)
"""
...
if hardware_connected:
    ...
    # 500KHz = 250MHz / 512 = 488281 KHz
    # 250KHz = 250MHz / 1024 = 244140 KHz
...
class GoPiGo3(object):
    ...
    def __init__(self, addr = 8, detect = True, config_file_path="/home/pi/Dexter/gpg3_config.json"):
        ...
        * Optionally disable the detection of the GoPiGo3 hardware. This can be used for debugging
        ...
        # Not Required on PiOS Bookworm on Raspberry Pi5 - pigpio not available for Pi5, PiOS sets up ALT0 mode
        # pi_gpio = pigpio.pi()
