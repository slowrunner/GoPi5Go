...
class GoPiGo3(object):
    ...
    def get_voltage_battery(self):
        ...
        try:
            ...
            print("spi_gopigo3.get_voltage_battery: Ignoring spi_read_16 exception: ",e, type(e).__name__)
            print("spi_gopigo3.get_voltage_battery: SPI errors:",self.spi_errors)
            value = 0
        return (value / 1000.0)
