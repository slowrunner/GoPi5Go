...
# spi_mutex_user2.py    Test mutex Protected SPI transfers for SPI errors 
#                with battery voltage with slightly different loop sleep
...
def printStatus(gpg,loopCnt):
    print("\n********* (user2) GoPi5Go-Dave MUTEX Protected SPI TEST {:d} STATUS *****".format(loopCnt))
