...
# ######### plotBattLife.py #########
#
# reads data file passed as parameter e.g. ./plotBatteryLife.py  csv/YYYY-mm-dd_batteryLife.csv
# output: plot of battery voltage vs up time to pic/YYYY-mm-dd_batteryLife.png
#
# REQ:
...
if (len(sys.argv) == 2):
    ...
    print("Usage:  ./plotBatteryLife.py csv/YYYY-mm-dd_batteryLife.csv")
    exit()
...
file_date = inFile[-26:inFile.find("_")]

print("file_date",file_date)
dtObj= datetime.datetime.strptime(file_date, '%Y-%m-%d')

#print("dtObj:",dtObj)
title_date = dtObj.strftime('%Y-%m-%d')
print("title_date: ",title_date)

pic_title = dtObj.strftime('%Y-%m-%d_batteryLife')
