...
public:
    ...
    // bool target_reached(float left_target_degrees, float right_target_degrees);   // my first cut
    bool target_reached(int32_t left_target_degrees, int32_t right_target_degrees);  //chatGPT
